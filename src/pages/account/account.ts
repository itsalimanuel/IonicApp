...
import { MyordersPagePage } from '../myorders/myorders';
...
export class AccountPage {
	...
	AboutPage = AboutPage;
	MyordersPagePage = MyordersPagePage;
	...
	myorderslk() {
		/*this.navCtrl.push(MyordersPagePage);*/
  let alert = this.alertCtrl.create({
    title: 'لا تملك تصريح لفتح هذه الصفحة',
    message: 'إذا كنت تريد نشر و إدارة خدماتك معنا يتوجب تقديم طلب لترقية حسابك لحساب مقدم خدمات عبر الصفحة التالية',
    buttons: [
